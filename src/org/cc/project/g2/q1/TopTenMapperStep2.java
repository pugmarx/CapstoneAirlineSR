...
public class TopTenMapperStep2 extends Mapper<Object, Text, AirportCarrierKey, NullWritable> {
    ...
    public void map(Object key, Text value, Context context)
        ...
        AirportCarrierKey aKey = new AirportCarrierKey(new Text(row[0]), new Text(row[1]));
    ...
    protected void cleanup(Context context) throws IOException,
        ...
        for (AirportCarrierKey key : avgToAirlineMap.keySet()) {
